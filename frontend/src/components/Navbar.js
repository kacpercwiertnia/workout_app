...
const NavbarComponent = () => {
    ...
    return (
        ...
        <a className="navbar-brand" role="button"  onClick={ () => {navigate("/")}}>TrainEverywhere</a>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
            {user ? (
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li className="nav-item" role="button">
                        <NavLink activeClassName="active" className="nav-link" to='/muscles'>Lista Mięśni</NavLink>
                    </li>
                </ul>
            ) : (
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
